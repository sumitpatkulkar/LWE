...
import "./ShippingPolicyStyle.css"
            ...
            <container>
                ...
                <div className="ShippingPolicy">
                    <ol type="1">
                        ...
                        <li>
                            <b>When and where do you usually deliver?</b><br />

                            We work on all days of the week. We do delivery, installation and pick-up. In case you do not have lift or permission to use lift at your premises, additional labor charges will be charged to carry the products through stairs. We are currently active in Bangalore, Mumbai, Pune, Delhi, Noida, Gurgaon, Hyderabad, Chennai, Ahmedabad, Mysore, Jaipur, Faridabad, Ghaziabad, Gandhinagar, Chandigarh & Kolkata. Please note: Installation for AC will incur additional charges, which will be communicated to you before placing the order.
                        </li>



                        <li>
                            <b> Do you help us with relocation?</b><br />
                        ...
                        <li>
                            <b>What if I am not at home at the time of delivery?</b><br />
                        ...
                        <li>
                            <b>What if my building does not have a lift?</b><br />
                        ...
                        <li>
                            <b>What if my society does not allow vehicles inside?</b><br />
                        ...
                        <li>
                            <b>Who deals with labor (hamaali) union and transport union issues?</b><br />
