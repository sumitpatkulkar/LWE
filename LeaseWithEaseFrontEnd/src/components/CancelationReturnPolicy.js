...
import "./CancelationReturnPolicyStyle.css"
function CancelationReturnPolicy() {
    return (
        <>
            <container>
                ...
                <div className="ReturnPolicy1">
                    <ol type="1">

                        <li>
                            <b>How and till when can I modify my order ?</b><br />
                        ...
                        <li>
                            <b>How can I cancel my existing order ?</b><br />
                        ...
                        <li>
                            <b> Can I return a few or all items of the order if I’m not happy with the products at the time of delivery ?</b><br />
                        ...
                        <li>
                            <b> Can I close my rental subscription prior to the committed tenure ?</b><br />
                            Yes, you can. In case of early termination of your order, you can request for closure for one or all your items by informing us 7 days before the selected preferred date. <b color="red">Early closure charge</b> will be applicable since the products will be returned before the end of your chosen tenure. To raise a closure request,
                            <ul>
                                <li>Log in to your RentoMojo account.</li>
                                ...
                                <p>To avoid early closure charges, you can also consider the following options.</p>
                        ...
                        <li>
                           <b> What are the early closure charges ?</b><br />
...
Please check your customer dashboard or your contract for the exact amount payable at any time.
                        ...
                        <li>
                            <b> How do I get my refundable deposit ?</b><br />
...
export default CancelationReturnPolicy;